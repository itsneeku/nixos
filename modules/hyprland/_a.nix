...
}:
{
  ...
  home.file.".config/waybar/config".source =
    config.lib.file.mkOutOfStoreSymlink /home/neeku/.nixos/modules/home-manager/hyprland/waybar/config;

  home.file.".config/waybar/style.css".source =
    config.lib.file.mkOutOfStoreSymlink /home/neeku/.nixos/modules/home-manager/hyprland/waybar/style.css;
